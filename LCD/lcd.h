...
#elif defined(__AVR_AT90S4414__) || defined(__AVR_AT90S8515__) || defined(__AVR_ATmega64__) || defined(__AVR_ATmega64A__) || \
...
/**
 @brief egyedi betu(k) beallitasa
 */
void lcd_defc( const uint8_t *s);

/**
 @brief 1 byte kiirasa binarisa
 */
void lcd_putbyte_bin( unsigned char c);

/**
 @brief 1 hexadecimalis szamjegy kiirasa
 */
void lcd_putc_hex( unsigned char c);

/**
 @brief 1 byte kiirasa hexadecimalisan
 */
...
/**
 @brief string kiiras, magyar betuk is
 */
void lcd_puts_hu( const char *s);
